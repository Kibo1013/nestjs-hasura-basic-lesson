...
export type Mutation_Root = {
  ...
  /** delete data from the table: "plofile_users" */
  delete_plofile_users?: Maybe<Plofile_Users_Mutation_Response>
  /** delete single row from the table: "plofile_users" */
  delete_plofile_users_by_pk?: Maybe<Plofile_Users>
  ...
  /** insert data into the table: "plofile_users" */
  insert_plofile_users?: Maybe<Plofile_Users_Mutation_Response>
  /** insert a single row into the table: "plofile_users" */
  insert_plofile_users_one?: Maybe<Plofile_Users>
  ...
  /** update data of the table: "plofile_users" */
  update_plofile_users?: Maybe<Plofile_Users_Mutation_Response>
  /** update single row of the table: "plofile_users" */
  update_plofile_users_by_pk?: Maybe<Plofile_Users>
...
/** mutation root */
export type Mutation_RootDelete_Plofile_UsersArgs = {
  where: Plofile_Users_Bool_Exp
}

/** mutation root */
export type Mutation_RootDelete_Plofile_Users_By_PkArgs = {
  id: Scalars['uuid']
}
...
/** mutation root */
export type Mutation_RootInsert_Plofile_UsersArgs = {
  objects: Array<Plofile_Users_Insert_Input>
  on_conflict?: InputMaybe<Plofile_Users_On_Conflict>
}

/** mutation root */
export type Mutation_RootInsert_Plofile_Users_OneArgs = {
  object: Plofile_Users_Insert_Input
  on_conflict?: InputMaybe<Plofile_Users_On_Conflict>
}
...
/** mutation root */
export type Mutation_RootUpdate_Plofile_UsersArgs = {
  _set?: InputMaybe<Plofile_Users_Set_Input>
  where: Plofile_Users_Bool_Exp
}

/** mutation root */
export type Mutation_RootUpdate_Plofile_Users_By_PkArgs = {
  _set?: InputMaybe<Plofile_Users_Set_Input>
  pk_columns: Plofile_Users_Pk_Columns_Input
}
...
/** columns and relationships of "plofile_users" */
export type Plofile_Users = {
  __typename?: 'plofile_users'
  id: Scalars['uuid']
  plofile_id: Scalars['uuid']
...
/** aggregated selection of "plofile_users" */
export type Plofile_Users_Aggregate = {
  __typename?: 'plofile_users_aggregate'
  aggregate?: Maybe<Plofile_Users_Aggregate_Fields>
  nodes: Array<Plofile_Users>
}

/** aggregate fields of "plofile_users" */
export type Plofile_Users_Aggregate_Fields = {
  __typename?: 'plofile_users_aggregate_fields'
  count: Scalars['Int']
  max?: Maybe<Plofile_Users_Max_Fields>
  min?: Maybe<Plofile_Users_Min_Fields>
}

/** aggregate fields of "plofile_users" */
export type Plofile_Users_Aggregate_FieldsCountArgs = {
  columns?: InputMaybe<Array<Plofile_Users_Select_Column>>
  distinct?: InputMaybe<Scalars['Boolean']>
}

/** order by aggregate values of table "plofile_users" */
export type Plofile_Users_Aggregate_Order_By = {
  count?: InputMaybe<Order_By>
  max?: InputMaybe<Plofile_Users_Max_Order_By>
  min?: InputMaybe<Plofile_Users_Min_Order_By>
}

/** input type for inserting array relation for remote table "plofile_users" */
export type Plofile_Users_Arr_Rel_Insert_Input = {
  data: Array<Plofile_Users_Insert_Input>
  /** on conflict condition */
  on_conflict?: InputMaybe<Plofile_Users_On_Conflict>
}

/** Boolean expression to filter rows from the table "plofile_users". All fields are combined with a logical 'AND'. */
export type Plofile_Users_Bool_Exp = {
  _and?: InputMaybe<Array<Plofile_Users_Bool_Exp>>
  _not?: InputMaybe<Plofile_Users_Bool_Exp>
  _or?: InputMaybe<Array<Plofile_Users_Bool_Exp>>
  id?: InputMaybe<Uuid_Comparison_Exp>
  plofile_id?: InputMaybe<Uuid_Comparison_Exp>
  profile?: InputMaybe<Profiles_Bool_Exp>
  user?: InputMaybe<Users_Bool_Exp>
  user_id?: InputMaybe<Uuid_Comparison_Exp>
}

/** unique or primary key constraints on table "plofile_users" */
export enum Plofile_Users_Constraint {
  /** unique or primary key constraint */
  PlofileNamesPkey = 'plofile_names_pkey',
}

/** input type for inserting data into table "plofile_users" */
export type Plofile_Users_Insert_Input = {
  id?: InputMaybe<Scalars['uuid']>
  plofile_id?: InputMaybe<Scalars['uuid']>
...
/** aggregate max on columns */
export type Plofile_Users_Max_Fields = {
  __typename?: 'plofile_users_max_fields'
  id?: Maybe<Scalars['uuid']>
  plofile_id?: Maybe<Scalars['uuid']>
  user_id?: Maybe<Scalars['uuid']>
}

/** order by max() on columns of table "plofile_users" */
export type Plofile_Users_Max_Order_By = {
  id?: InputMaybe<Order_By>
  plofile_id?: InputMaybe<Order_By>
  user_id?: InputMaybe<Order_By>
}

/** aggregate min on columns */
export type Plofile_Users_Min_Fields = {
  __typename?: 'plofile_users_min_fields'
  id?: Maybe<Scalars['uuid']>
  plofile_id?: Maybe<Scalars['uuid']>
  user_id?: Maybe<Scalars['uuid']>
}

/** order by min() on columns of table "plofile_users" */
export type Plofile_Users_Min_Order_By = {
  id?: InputMaybe<Order_By>
  plofile_id?: InputMaybe<Order_By>
  user_id?: InputMaybe<Order_By>
}

/** response of any mutation on the table "plofile_users" */
export type Plofile_Users_Mutation_Response = {
  __typename?: 'plofile_users_mutation_response'
  /** number of rows affected by the mutation */
  affected_rows: Scalars['Int']
  /** data from the rows affected by the mutation */
  returning: Array<Plofile_Users>
}

/** on conflict condition type for table "plofile_users" */
export type Plofile_Users_On_Conflict = {
  constraint: Plofile_Users_Constraint
  update_columns?: Array<Plofile_Users_Update_Column>
  where?: InputMaybe<Plofile_Users_Bool_Exp>
}

/** Ordering options when selecting data from "plofile_users". */
export type Plofile_Users_Order_By = {
  id?: InputMaybe<Order_By>
  plofile_id?: InputMaybe<Order_By>
...
/** primary key columns input for table: plofile_users */
export type Plofile_Users_Pk_Columns_Input = {
  id: Scalars['uuid']
}

/** select columns of table "plofile_users" */
export enum Plofile_Users_Select_Column {
  /** column name */
  Id = 'id',
  /** column name */
  PlofileId = 'plofile_id',
  /** column name */
  UserId = 'user_id',
}

/** input type for updating data in table "plofile_users" */
export type Plofile_Users_Set_Input = {
  id?: InputMaybe<Scalars['uuid']>
  plofile_id?: InputMaybe<Scalars['uuid']>
  user_id?: InputMaybe<Scalars['uuid']>
}

/** update columns of table "plofile_users" */
export enum Plofile_Users_Update_Column {
  /** column name */
  Id = 'id',
  /** column name */
  PlofileId = 'plofile_id',
...
export type Profiles = {
  ...
  plofile_users: Array<Plofile_Users>
  /** An aggregate relationship */
  plofile_users_aggregate: Plofile_Users_Aggregate
  /** An object relationship */
  user?: Maybe<Users>
}

/** columns and relationships of "profiles" */
export type ProfilesPlofile_UsersArgs = {
  distinct_on?: InputMaybe<Array<Plofile_Users_Select_Column>>
  limit?: InputMaybe<Scalars['Int']>
  offset?: InputMaybe<Scalars['Int']>
  order_by?: InputMaybe<Array<Plofile_Users_Order_By>>
  where?: InputMaybe<Plofile_Users_Bool_Exp>
}

/** columns and relationships of "profiles" */
export type ProfilesPlofile_Users_AggregateArgs = {
  distinct_on?: InputMaybe<Array<Plofile_Users_Select_Column>>
  limit?: InputMaybe<Scalars['Int']>
  offset?: InputMaybe<Scalars['Int']>
  order_by?: InputMaybe<Array<Plofile_Users_Order_By>>
...
export type Profiles_Bool_Exp = {
  ...
  plofile_users?: InputMaybe<Plofile_Users_Bool_Exp>
  user?: InputMaybe<Users_Bool_Exp>
}
...
export type Profiles_Insert_Input = {
  ...
  plofile_users?: InputMaybe<Plofile_Users_Arr_Rel_Insert_Input>
  user?: InputMaybe<Users_Obj_Rel_Insert_Input>
}
...
export type Profiles_Order_By = {
  ...
  plofile_users_aggregate?: InputMaybe<Plofile_Users_Aggregate_Order_By>
  user?: InputMaybe<Users_Order_By>
}
...
export type Query_Root = {
  ...
  /** An aggregate relationship */
  plofile_users_aggregate: Plofile_Users_Aggregate
  /** fetch data from the table: "plofile_users" using primary key columns */
  plofile_users_by_pk?: Maybe<Plofile_Users>
...
export type Query_RootPlofile_UsersArgs = {
  distinct_on?: InputMaybe<Array<Plofile_Users_Select_Column>>
  limit?: InputMaybe<Scalars['Int']>
  offset?: InputMaybe<Scalars['Int']>
  order_by?: InputMaybe<Array<Plofile_Users_Order_By>>
...
export type Query_RootPlofile_Users_AggregateArgs = {
  distinct_on?: InputMaybe<Array<Plofile_Users_Select_Column>>
  limit?: InputMaybe<Scalars['Int']>
  offset?: InputMaybe<Scalars['Int']>
  order_by?: InputMaybe<Array<Plofile_Users_Order_By>>
...
export type Query_RootPlofile_Users_By_PkArgs = {
  id: Scalars['uuid']
}
...
export type Subscription_RootPlofile_UsersArgs = {
  distinct_on?: InputMaybe<Array<Plofile_Users_Select_Column>>
  limit?: InputMaybe<Scalars['Int']>
  offset?: InputMaybe<Scalars['Int']>
  order_by?: InputMaybe<Array<Plofile_Users_Order_By>>
...
export type Subscription_RootPlofile_Users_AggregateArgs = {
  distinct_on?: InputMaybe<Array<Plofile_Users_Select_Column>>
  limit?: InputMaybe<Scalars['Int']>
  offset?: InputMaybe<Scalars['Int']>
  order_by?: InputMaybe<Array<Plofile_Users_Order_By>>
...
export type Subscription_RootPlofile_Users_By_PkArgs = {
  id: Scalars['uuid']
}
...
export type Users = {
  ...
  name: Scalars['String']
  /** An array relationship */
  plofile_names: Array<Plofile_Users>
  /** An aggregate relationship */
  plofile_names_aggregate: Plofile_Users_Aggregate
  /** An object relationship */
...
/** columns and relationships of "users" */
export type UsersPlofile_NamesArgs = {
  distinct_on?: InputMaybe<Array<Plofile_Users_Select_Column>>
  limit?: InputMaybe<Scalars['Int']>
  offset?: InputMaybe<Scalars['Int']>
  order_by?: InputMaybe<Array<Plofile_Users_Order_By>>
...
/** columns and relationships of "users" */
export type UsersPlofile_Names_AggregateArgs = {
  distinct_on?: InputMaybe<Array<Plofile_Users_Select_Column>>
  limit?: InputMaybe<Scalars['Int']>
  offset?: InputMaybe<Scalars['Int']>
  order_by?: InputMaybe<Array<Plofile_Users_Order_By>>
...
export type Users_Bool_Exp = {
  ...
  id?: InputMaybe<Uuid_Comparison_Exp>
  name?: InputMaybe<String_Comparison_Exp>
  plofile_names?: InputMaybe<Plofile_Users_Bool_Exp>
  profile?: InputMaybe<Profiles_Bool_Exp>
...
export type Users_Insert_Input = {
  ...
  id?: InputMaybe<Scalars['uuid']>
  name?: InputMaybe<Scalars['String']>
  plofile_names?: InputMaybe<Plofile_Users_Arr_Rel_Insert_Input>
  profile?: InputMaybe<Profiles_Obj_Rel_Insert_Input>
...
export type Users_Order_By = {
  ...
  id?: InputMaybe<Order_By>
  name?: InputMaybe<Order_By>
  plofile_names_aggregate?: InputMaybe<Plofile_Users_Aggregate_Order_By>
  profile?: InputMaybe<Profiles_Order_By>
  profile_id?: InputMaybe<Order_By>
}
